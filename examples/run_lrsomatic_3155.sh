...
"$HERE/run_reconplot.R" --cn-source ascat --sv-source severus --input "$IN" --outdir "$OUT/per_chromosome" \
  --regions all --layout separate --format pdf,png --write-tables

"$HERE/run_reconplot.R" --cn-source ascat --sv-source severus --input "$IN" --outdir "$OUT/genome_wide" \
...
"$HERE/run_reconplot.R" --cn-source ascat --sv-source severus --input "$IN" --outdir "$OUT/focus_cluster" \
...
"$HERE/run_reconplot.R" --cn-source ascat --sv-source severus --input "$IN" --outdir "$OUT/rearrangements_only" \
